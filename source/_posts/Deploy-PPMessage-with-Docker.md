title: PPMessage & Docker
date: 2016-03-04 20:07:21
tags:
description: 使用 Docker 搭建 PPMessage 开发环境, 运行PPMessage
...
你也可以通过运行脚本 `~/Documents/ppmessage/ppmessage/docker/run-ppmessage.sh` 来启动 PPMessage。该脚本内容就是上面的启动命令。
